	...
	public class XMLLoader extends DataLoader {
		...
		override protected function _calculateProgress():void { 
			...
			if (_cachedBytesTotal < _cachedBytesLoaded) {
				_cachedBytesTotal = _cachedBytesLoaded; //In Chrome when the XML file exceeds a certain size and gzip is enabled on the server, Adobe's URLLoader reports bytesTotal as 0!!!
			}
